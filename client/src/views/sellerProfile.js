...
class sellerProfile extends Component {
    ...
    componentDidMount = async () => {
        ...
        try{
            ...
            //sellerTable.push(<div><p>Name: {seller[0]}</p><p>Age: {seller[1]}</p><p>Kebele ID: {seller[2]}</p><p>TIN: {seller[3]}</p><p>Owned Lands: {seller[4]}</p></div>);
              sellerTable.push(<>
              <Row>
                <Col md="12">
                  <FormGroup>
              ...
              <Row>
                <Col md="12">
                  <FormGroup>
                    <label>Your Kebele ID Document</label>
