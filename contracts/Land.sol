...
contract Land {
    ...
    function registerSeller(string memory _name, uint _age, string memory _nationalID, string memory _tinNumber, string memory _landsOwned, string memory _document) public {
        ...
        sellersCount++;
        SellerMapping[msg.sender] = Seller(msg.sender, _name, _age, _nationalID,_tinNumber, _landsOwned, _document);
        sellers.push(msg.sender);
        emit Registration(msg.sender);
    }

    function updateSeller(string memory _name, uint _age, string memory _nationalID, string memory _tinNumber, string memory _landsOwned) public {
        ...
        SellerMapping[msg.sender].nationalID = _nationalID;
    ...
    function getSellerDetails(address i) public view returns (string memory, uint, string memory, string memory, string memory, string memory) {
        return (SellerMapping[i].name, SellerMapping[i].age, SellerMapping[i].nationalID, SellerMapping[i].tinNumber, SellerMapping[i].landsOwned, SellerMapping[i].document);
    }

    function registerBuyer(string memory _name, uint _age, string memory _city, string memory _nationalID, string memory _tinNumber, string memory _document, string memory _email) public {
        ...
        buyersCount++;
        BuyerMapping[msg.sender] = Buyer(msg.sender, _name, _age, _city, _nationalID, _tinNumber, _document, _email);
        buyers.push(msg.sender);

        emit Registration(msg.sender);
    }

    function updateBuyer(string memory _name,uint _age, string memory _city,string memory _nationalID, string memory _email, string memory _tinNumber) public {
        ...
        BuyerMapping[msg.sender].nationalID = _nationalID;
    ...
    function getBuyerDetails(address i) public view returns ( string memory,string memory, string memory, string memory, string memory, uint, string memory) {
        return (BuyerMapping[i].name,BuyerMapping[i].city , BuyerMapping[i].tinNumber, BuyerMapping[i].document, BuyerMapping[i].email, BuyerMapping[i].age, BuyerMapping[i].nationalID);
    }
