...
contract("Land", function(accounts){
    ...
    it("allows a seller to register", function() {
        return Land.deployed().then(function(instance) {
            landReginstance = instance;
            return landReginstance.registerSeller("Seller Name", 20, "nationalID123", "tinNumber123", "many", "QmYdztkcPJLmGmwLmM4nyBfVatoBMRDuUjmgBupjmTodAP", {from: seller});
    ...
    it("allows a buyer to register", function() {
        return Land.deployed().then(function(instance) {
            landReginstance = instance;
            return landReginstance.registerBuyer("Buyer Name", 20, "akola", "nationalID123", "tinNumber123", "QmYdztkcPJLmGmwLmM4nyBfVatoBMRDuUjmgBupjmTodAP", "buyer@example.com", {from: buyer});
        }).then(function(receipt) {
          assert.equal(receipt.logs.length, 1, "an event was triggered");
          assert.equal(receipt.logs[0].event, "Registration", "the event type is correct");
    ...
    it("allows a registered and verified seller to edit his/her profile", function() {
        return Land.deployed().then(function(instance) {
            landReginstance = instance;
            return landReginstance.updateSeller("Updated Seller Name", 21, "nationalID999", "tinNumber999", "ten", {from: seller});
        }).then(function(receipt) {
          assert.equal(receipt.logs.length, 0, "Receipt");
          return landReginstance.sellersCount();
        }).then(function(count) {
